...
<?php
        $ch = curl_init();
        curl_setopt($ch, CURLOPT_URL, "https://api.fortnitetracker.com/v1/profile/pc/SypherPK");
...
<h3> Ali "Sypher" </h3>
<div class="bio">
 <div class="element"> <img class="player" src="images/pk.jpg"></img></div>
 <div class="element_text"><p>A growing streamer in the Fortnite community, Sypher is among the top players in the world when it comes to both wins and kills in Fortnite. A younger streamer, Sypher brings a unique play style that can best be described as cautious aggression. Sypher is best known for his enjoyment of trap kills.</p></div>
 <div class="element"><a href="fortnite_players.html"><img class="team_logo" src="images/sypher.jpg"></img></div>
</div>
...
<script>
    ...
    function onYouTubeIframeAPIReady() {
        player = new YT.Player('player', {
                               ...
                               {
                               listType: 'playlist',
                               list: 'PLXm4ijgo1i0E2sUbj6eIYyMzPtCYlLXGn'
                               }
